      ...
      <div class="page-header">
        ...
        <div class="mt-4 sm:mt-0 flex gap-3">
          <button
            ...
            class="btn btn-success flex items-center justify-center gap-2 px-6 py-3 shadow-md hover:shadow-lg"
          >
        ...
        <div v-for="bot in bots" :key="bot.id" class="bot-card">
          ...
          <div class="card-footer flex gap-2">
            ...
            <button
              ...
              class="btn btn-danger btn-sm flex-1 flex items-center justify-center gap-2"
            >
        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="saveBot" class="space-y-4">
            <div class="form-group">
              ...
              />
              <p v-if="editingBot" class="form-hint">Bot identifier cannot be changed</p>
            </div>
            <div class="form-group">
